...
export class FooterComponent {
  ...
  faqs = [
    { question: "O que é?", answer: "Somos uma empresa jovem, dinâmica e focada em consolidar nossa presença no mercado de desenvolvimento web, entregando resultados excepcionais em tudo o que fazemos.", open: false },
